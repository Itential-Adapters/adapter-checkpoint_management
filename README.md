...
1. Add the adapter properties for Checkpoint_Management (created from Adapter Builder) to the `properties.json` file for your Itential build. You will need to change the credentials and possibly the host information below.
[Checkpoint_Management sample properties](sampleProperties.json)
