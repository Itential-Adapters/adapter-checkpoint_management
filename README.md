...
<table border="1" class="bordered-table">
  ...
  <tr>
    ...
    <td style="padding:15px">Provides a connectivity check to the Checkpoint_Management system.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run healthcheck</td>
    <td style="padding:15px">Checks whether the configured healthcheck call works to Checkpoint_Management.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run basicget</td>
    <td style="padding:15px">Checks whether the basic get calls works to Checkpoint_Management.</td>
  </tr>
</table>
<br>
