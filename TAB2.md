...
```
### [Swagger](https://Itential-Adapters/adapter-checkpoint_management/-/blob/master/report/adapter-openapi.json) 

## [Generic Adapter Information](https://Itential-Adapters/adapter-checkpoint_management/-/blob/master/README.md) 
